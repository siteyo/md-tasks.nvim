...
function M.show_tasks(states)
  search.search_tasks({
    ...
    on_select = function(tasks)
      ...
      local on_task_select = function(selected_task)
      ...
      picker.open("tasks", tasks, on_task_select)
    end,
  })
end

---@param states string[]?
function M.show_files(states)
  search.search_files({
    states = states,
    on_select = function(files)
      ...
      local on_file_select = function(selected_file)
      ...
      picker.open("files", files, on_file_select)
    end,
  })
end
